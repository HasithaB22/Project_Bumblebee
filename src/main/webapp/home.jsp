...
<section class="d-flex bg-warning" style="margin-top: 20px;">
    <div class="container-fluid d-flex" style="max-width: 1200px">

    <div class="main-items w-25 d-flex justify-content-center bg-danger" style="max-width: 500px;">
        <div class="tabbable tabs-left bg-danger d-flex justify-content-center" style="width: 90%; height: auto; padding-left: 5px;">
            <div class="list-group">
                ...
                <button type="button" class="list-group-item list-group-item-action" >Wemen's Fashion</button>
                <button type="button" class="list-group-item list-group-item-action" >Wemen's Fashion</button>
                <button type="button" class="list-group-item list-group-item-action" >Wemen's Fashion</button>
                <button type="button" class="list-group-item list-group-item-action" >Wemen's Fashion</button>
                <button type="button" class="list-group-item list-group-item-action" >Wemen's Fashion</button>
    ...
    <div id="carousel" class="carousel carousel-fade slide normalsize centerslider w-100" data-bs-interval="3000" data-bs-ride="carousel" >
        <div class="carousel-inner">
            <div class="carousel-item active ">
                <img src="recourses/images/home/1.jpg" class="d-block img-fluid w-120 "  >
            </div>
            <div class="carousel-item">
                <img src="recourses/images/home/2.jpg" class="d-block img-fluid w-120" >
            </div>
            <div class="carousel-item">
                <img src="recourses/images/home/1.jpg" class="d-block img-fluid w-120"  >
            </div>
