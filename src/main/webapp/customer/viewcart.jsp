...
<div class="container-fluid" style="max-width: 1200px;">
    ...
    <table class="table" border="1">
        ...
        <tr>
            <td class="bg-info p-3" style="text-align: center; color: white" colspan="5"><h3>TOTAL</h3></td>
    ...
    <div style="text-align:right; align-content: end; justify-content: right; margin-bottom: 1%">
        <a class="text" href="orderConfirmation"><button class="btn" style="background-color: #0b5ed7; color: white"><b>Checkout</b></button></a>
    </div>
