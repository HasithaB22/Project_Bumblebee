        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <table class="table">
                    ...
                    <tr>
                        <td class="bg-info p-3" style="text-align: center; color: white" colspan="3"><h3>Total</h3></td>
                        <td style="text-align: right" colspan="2"><b>LKR ${total}.00</b></td>
                        <input type="hidden" id="total" value="${total}" name="total">
                    </tr>
                </table>
                <button type="submit" class="btn" style="background-color: #0b5ed7; color: white">Confirm Order</button>
            </div>
        </div>
    </form>
</div>
