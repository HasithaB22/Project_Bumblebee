...
<%--    <script src="https://cdn.jsdelivr.net/npm/popper.js@1.16.0/dist/umd/popper.min.js"></script>--%>
    ...
    <style>
        ...
        .homepage_productcarousel .dealscarousel .carousel {
            margin: 50px auto;
            padding: 0 70px;
            margin-top: 10px;
        }
...
<section class="homepage_productcarousel" style = "background-color: #292B2CFF; min-height: 450px;margin-top: 20px">
    <div class="container-fluid d-flex" style="max-width: 1200px; min-height: 450px;">
        <div class="container">


            <div class="container-fluid d-flex mb-0" style="background-color: #2537b4">
